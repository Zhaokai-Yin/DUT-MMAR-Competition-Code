...
def main():
    parser = argparse.ArgumentParser(description='精确复现92.54分（ConvNeXt + 骨骼点 + SVM）')
    ...
    parser.add_argument('--output', type=str, default='submission_92_54_exact.csv')
