...
def main():
    parser = argparse.ArgumentParser(description='零样本/少样本推理 - 快速生成结果')
    ...
    parser.add_argument('--num_segments', type=int, default=16,
                       help='视频分段数量（R(2+1)D需要16帧，会自动处理）')
    ...
    if test_video_ids is None:
        raise ValueError("未能提取到测试集的video_ids，请检查数据集配置")
